...
- GitHub Actions builds the public artifact with `scripts/build-pages.sh` and syncs it to the `aiforwork.courses` and `www.aiforwork.courses` buckets in Yandex Object Storage.
